...
extension RazeCore {
  public class Color {
    ...
    internal class func fromHexDecString(_ hexString: String, alpha: CGFloat = 1.0) -> UIColor {
      let r, g, b: CGFloat
